 ...
 */
abstract class WC_SC_Background_Process extends WP_Background_Process {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->identifier . '_cron_interval' ] = array(
			...
			'display'  => sprintf( __( 'Every %d minutes', 'woocommerce-smart-coupons' ), $interval ),
		);
	 ...
	 * Delete all batches.
	 *
	 * @return WC_SC_Background_Process
	 */
